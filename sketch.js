...
background("Purple")
  ...
  if (gameState == 0) {
    ...
    text("3. For every question you will get 30 seconds to answer", 50, 300)
  ...
  if (life > 0) {
    if (gameState === 1) {
      ...
      fill("lightgreen")
      textSize(30)
      text("SCORE : " + score, width - 270, 50);
      textSize(30)
      text("LIFE : ", width - 270, 100);
     // text(mouseX+" , "+mouseY,mouseX,mouseY)
      for (i = 0; i < life; i++) {
        image(lifeImg, (width - 185) + i * 40, 75, 30, 30)
      }
      ...
      if (questionShow) {
        ...
        if (q == 1) {
          ...
          question("1. In Which Year Did BTS Debut?",width / 2 - 250, 25)
        ...
        if (q == 2) {
          que.remove()
          // ans.remove()
          question("2. How many members are there in BTS?",width / 2 - 300, 25)
          options(5, 6, 7, 8)
          answer = 3;
          questionShow = false
        }
        if (q == 3) {
          que.remove()
          question("3. Who is the leader of BTS?" ,width / 2 - 250, 25)
        ...
        if (q == 4) {
          ...
          question(" BONUS QUESTION :<br/> What is the fandom of BTS called ?" ,width / 2 - 250, 25)
        ...
        if (q == 5) {
          que.remove()
          question("4. Who are the visuals of BTS?" ,width / 2 - 250, 25)
        ...
        if (q == 6) {
          que.remove()
          question("5. What is the full form of BTS?",width / 2 - 250, 25)
        ...
        if (q == 7) {
          que.remove()
          question("6. Guess the member in the picture?" ,width / 2 - 250, 25)
        ...
        if (q == 8) {
          que.remove()
          question(" BONUS QUESTION :<br/> In which entertainment does BTS work ?",width / 2 - 300, 25)
        ...
        if (q == 9) {
          que.remove()
          question("7. Who is  known as  AgustD in BTS ?",width / 2 - 250, 25)
        ...
        if (q == 10) {
          que.remove()
          question("8. Who is  maknae(youngest member)  of  BTS ?",width / 2 - 300, 25)
        ...
        if (q == 11) {
          que.remove()
          question("9. Who is the rapper ?",width / 2 - 200, 25)
        ...
        if (q == 12) {
          que.remove()
          question("10. Who is the vocalist ?",width / 2 - 200, 25)
        ...
        if (q == 13) {
          que.remove()
          question(" BONUS QUESTION :<br/> Who is known as WWH (World Wide Handsome) for BTS ARMY?",width / 2 - 480, 20)
...
function question(qt,x,y) {
  que = createElement('h1', qt)
  que.position(x,y)
  que.class("question")
}
